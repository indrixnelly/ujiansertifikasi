    ...
    <section id="about" class="section">
        <div class="container">
            <div class="section-header">          
                <h2 class="section-title">Konstruksi Gedung Hunian</h2>
                <span>Konstruksi Gedung Hunian</span><br><br>
            ...
            <div class="container marketing">
                <div class="row featurette">
                    <div class="col-md-12">
                        ...
                        <p class="justify-content-between teks">Kami menyediakan layanan konstruksi gedung hunian yang mencakup perencanaan, desain, 
                          dan pembangunan rumah tinggal, apartemen, dan kompleks perumahan. Dengan tim arsitek dan insinyur berpengalaman, 
                          kami menjamin setiap proyek selesai tepat waktu, sesuai anggaran, dan dengan kualitas terbaik.</p>
