...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Sistem Informasi | ASA WIDIANTARA</title>
    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
                    ...
                    @csrf
                      <div class="bg-white dark__bg-1000 rounded-2 py-2">
                        <button class="d-flex align-items-center gap-2 dropdown-item">
                          <a href="/" style="text-decoration:none;">Tampilan Pengguna</a>
                        </button>
                        <button type="submit" class="d-flex align-items-center gap-2 dropdown-item">
                          <a class="" style="text-decoration:none;">Keluar</a>
                        </button>
                      </div>
                  </form>
                </div>
          ...
          <footer class="footer">
            <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
              <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 text-600">Dikembangkan oleh <a href="https://pcr.ac.id/" rel="nofollow">Politeknik Caltex Riau</a><span class="d-none d-sm-inline-block"> | </span><br class="d-sm-none" /> 2024</p>
              </div>
              <div class="col-12 col-sm-auto text-center">
