...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>ASA WIDIANTARA | LOGIN</title>
    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form action="/login" method="post">
                       @csrf
                        ...
                        <div class="row flex-between-center">
                          <div class="col-auto">
                            <div class="form-check mb-0">
                              ...
                              <label class="form-check-label mb-0" for="card-checkbox">Ingatkan saya</label>
                            </div>
                          </div>
                        ...
                        <div class="col-auto">Belum punya akun? <a class="fs--0" href="/registrasi" style="text-decoration:none;">Registrasi</a>.</div>
                      </form>
                    </div>
                  </div>
                </div>
