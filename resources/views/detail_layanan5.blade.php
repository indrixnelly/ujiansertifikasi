    ...
    <section id="about" class="section">
        <div class="container">
            <div class="section-header">          
                <h2 class="section-title">Angkutan Bermotor Untuk Barang Umum</h2>
                <span>Angkutan Bermotor Untuk Barang Umum</span><br><br>
            ...
            <div class="container marketing">
                <div class="row featurette">
                    <div class="col-md-12">
                        ...
                        <p class="justify-content-between teks">kami menyediakan layanan angkutan bermotor untuk barang umum, 
                          menawarkan solusi pengiriman yang aman dan efisien untuk berbagai jenis barang. 
                          Dengan pengemudi yang profesional, 
                          kami menjamin barang Anda sampai ke tujuan dengan tepat waktu dan dalam kondisi yang baik.</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <div class="textwidget">
                <p>CV Asa Widiantara handles every project
                  with detail, high dedication and priority on quality.
                </p>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
