    ...
    <section id="about" class="section">
        <div class="container">
            <div class="section-header">          
                <h2 class="section-title">Perdagangan Suku Cadang Elektronik</h2>
                <span>Perdagangan Suku Cadang Elektronik</span><br><br>
            ...
            <div class="container marketing">
                <div class="row featurette">
                    <div class="col-md-12">
                        ...
                        <p class="justify-content-between teks">kami menyediakan layanan perdagangan suku cadang elektronik, 
                          menyediakan berbagai komponen dan peralatan elektronik untuk kebutuhan industri dan perorangan. 
                          Kami menjamin produk yang kami jual adalah asli, berkualitas tinggi, dan dengan harga yang kompetitif.</p>
