    ...
    <section id="about" class="section">
        <div class="container">
            <div class="section-header">          
                <h2 class="section-title">Instalasi Listrik & Mekanikal</h2>
                <span>Instalasi Listrik & Mekanikal</span><br><br>
            ...
            <div class="container marketing">
                <div class="row featurette">
                    <div class="col-md-12">
                        ...
                        <p class="justify-content-between teks">Kami menyediakan layanan instalasi listrik dan mekanikal 
                          untuk berbagai jenis bangunan, mulai dari hunian hingga komersial. Layanan kami mencakup pemasangan 
                          sistem listrik, dan sistem pipa mekanikal. 
                          Kami memastikan semua instalasi memenuhi standar keselamatan dan efisiensi energi.</p>
